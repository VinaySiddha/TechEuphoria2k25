...
const EEE = () => {
  ...
  const events = [
    { name: 'Power Systems', description: 'Explore modern power systems and grids.' },
    { name: 'Control Systems', description: 'Learn about control systems and automation.' },
    { name: 'Electrical Machines', description: 'Understand the working of electrical machines.' },
  ];
