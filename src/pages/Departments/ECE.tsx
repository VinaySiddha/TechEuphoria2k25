...
const ECE = () => {
  ...
  const events = [
    { name: 'Circuit Design', description: 'Design and build electronic circuits.' },
    { name: 'Robotics Workshop', description: 'Learn about robotics and automation.' },
    { name: 'Communication Systems', description: 'Explore modern communication technologies.' },
  ];
