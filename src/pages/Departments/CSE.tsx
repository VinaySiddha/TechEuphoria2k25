...
const CSE = () => {
  ...
  const events = [
    { name: 'Hackathon', description: '24-hour coding challenge to solve real-world problems.' },
    { name: 'Project Expo', description: 'Showcase your innovative projects.' },
    { name: 'Paper Presentation', description: 'Present your research papers on emerging technologies.' },
  ];
