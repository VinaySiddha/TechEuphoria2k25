...
function DepartmentsPage() {
  ...
  const departments = [
    ...
    { name: 'Computer Science with Artificial Intelligence', description: 'Learn about computer science with AI.', image: 'https://i.pinimg.com/736x/3d/7b/5a/3d7b5ab723384d8d46a8531842c8858e.jpg', path: '/departments/cai' },
    ...
    {name:'Pharmaceutical science',description:'Learn about Pharmaceutical science.' ,image:'https://as2.ftcdn.net/jpg/02/76/69/43/1000_F_276694328_7eeiKPIDOGR4LaSYhKBGjEmC7ERexPxv.webp',path:'/department/pharm'},
